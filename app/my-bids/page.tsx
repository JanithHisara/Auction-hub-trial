    ...
    <div className="min-h-screen bg-[var(--background)] relative">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-12">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-4xl font-black text-white">My Bids</h1>
          <span className="px-4 py-2 bg-[var(--surface)] rounded-full text-[var(--text-secondary)]">
            ...
            return (
              ...
              >
                <div className="flex gap-4 p-5">
                  {/* Image */}
                  <div className="flex-shrink-0 w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden bg-[var(--surface)]">
                    {bid.imageUrl ? (
                      <img
                        src={bid.imageUrl}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <h3 className="text-lg font-bold text-white group-hover:text-[var(--gold)] transition-colors truncate">
                        {gem.name as string}
                      </h3>
                      {isHighest && isActive && (
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
                      <div>
                        <p className="text-xs text-[var(--text-muted)]">Your Bid</p>
                      ...
                      {isActive && (
                        <div>
                          <p className="text-xs text-[var(--text-muted)]">Ends In</p>
