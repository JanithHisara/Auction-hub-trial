...
import { Check, Loader2, Trophy, LogOut } from 'lucide-react'
              ...
              {items.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-shrink-0 w-[140px] lg:w-full p-3 lg:p-4 rounded-xl text-left transition-all relative ${userWonThisItem
